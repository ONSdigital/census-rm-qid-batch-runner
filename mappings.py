...
PRODUCTPACK_CODE_TO_DESCRIPTION = {
    'D_FD_H1': 'Household Questionnaire for England',
    'D_FD_H2': 'Household Questionnaire for Wales (English)',
    'D_FD_H2W': 'Household Questionnaire for Wales (Welsh)',
    'D_FD_H4': 'Household Questionnaire for Northern Ireland (English)',
    'D_FD_HC1': 'Continuation Questionnaire for England',
    'D_FD_HC2': 'Continuation Questionnaire for Wales (English)',
    'D_FD_HC2W': 'Continuation Questionnaire for Wales (Welsh)',
    'D_FD_I1': 'Individual Questionnaire for England',
    'D_FD_I2': 'Individual Questionnaire for Wales (English)',
    'D_FD_I2W': 'Individual Questionnaire for Wales (Welsh)',
    'D_FD_I4': 'Individual Questionnaire for Northern Ireland (English)',
    ...
    'D_CCS_CHP2': 'CCS Postback for Wales (English)',
    'D_CCS_CHP2W': 'CCS Postback for Wales (Welsh)',
    'D_CCS_CCP1': 'CCS Postback Continuation Questionnaire for England',
    'D_CCS_CCP2': 'CCS Postback Continuation Questionnaire for Wales (English)',
    'D_CCS_CCP2W': 'CCS Postback Continuation Questionnaire for Wales (Welsh)',
    'D_CCS_CCE1': 'CCS Interviewer CE Manager for England and Wales',
    'D_CCS_CCE2W': 'CCS Interviewer CE Manager for Wales (Welsh)',
    'D_FDCE_H1U': 'Household Questionnaire for England (UNADDRESSED) (CE)',
    ...
    'D_FDCE_I1U': 'Individual Questionnaire for England (UNADDRESSED) (CE)',
